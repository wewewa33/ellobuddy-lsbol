...
namespace Jhin.Champions
{
    public class ChampionBase
    {
        ...
        {
            get { return MenuManager.GetSubMenu("Giết Steal"); }
        }

        public Menu HarassMenu
        {
            get { return MenuManager.GetSubMenu("quấy rối đối phương"); }
        }
        ...
        {
            get { return MenuManager.GetSubMenu("Vòng Skill"); }
        }

        public Menu FleeMenu
        {
            get { return MenuManager.GetSubMenu("Trốn Tránh"); }
        }
        ...
        {
            get { return MenuManager.GetSubMenu("Né Skill"); }
        }
        public Menu UltimateMenu
        {
            get { return MenuManager.GetSubMenu("Tối hậu"); }
        }
