...
namespace Hellsing.Kalista
{
    ...
    {
        private const string MenuName = "Kalista By KhoNan";
        ...
        static Config()
        {
            ...
            Menu.AddLabel("Chào mừng đến bản việt hóa đầu tay :D!");
        ...
        public static class Modes
        {
            ...
            public static class Combo
            {
                ...
                static Combo()
                {
                    ...
                    _useQ = Menu.Add("comboUseQ", new CheckBox("sử dụng Q"));
                    _useQAA = Menu.Add("comboUseQAA", new CheckBox("Sử dụng Q chỉ sau cuộc tấn công tự động"));
                    _useE = Menu.Add("comboUseE", new CheckBox("sử dụng E"));
                    _useEslow = Menu.Add("comboUseEslow", new CheckBox("Giết tay sai với E để làm chậm kẻ thù"));
                    _useAA = Menu.Add("comboUseAA", new CheckBox("tay sai tấn công để khoảng cách gần"));
                    _useItems = Menu.Add("comboUseItems", new CheckBox("Use items"));
                    _numE = Menu.Add("comboNumE", new Slider("Tối thiểu ống xả để sử dụng E", 5, 1, 50));
                    _mana = Menu.Add("comboMana", new Slider("sử dụng Mana cho Q theo phần trăm ({0}%)", 30));
                }
